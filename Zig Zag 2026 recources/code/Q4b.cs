        ...
        static string GetSimChoice()
        {
            ...
            while (!ValidChoice)
            {
                ...
                try
                {
                    ...
                    if (ChoiceAsInt > 0 && ChoiceAsInt < 5)
                    {
                        ValidChoice = true;
                        return Choice;
                    }
