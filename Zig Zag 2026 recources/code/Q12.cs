...
namespace AntSimCS      //Q12
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            //CHANGE
            int SimNo = GetInputInRange("Enter the simulation you want to run (1-4) enter 5 to create a custom simulation: ", 1, 5);
            switch (SimNo)
            {
                case 1:
                ...
                case 4:
                    ...
                    break;
                case 5:
                    SimulationParameters = GetCustomSimulation();
                    break;
        ...
        //CHANGE
        static List<int> GetCustomSimulation()
        {
            List<int> SimulationParameters = new List<int>();
            SimulationParameters.Add(GetInputInRange("Enter number of nests (1-5): ", 1, 5));
            SimulationParameters.Add(GetInputInRange("Enter number of rows (5-20): ", 5, 20));
            SimulationParameters.Add(GetInputInRange("Enter number of columns (5-20): ", 5, 20));
            SimulationParameters.Add(GetInputInRange("Enter starting food in each nest (100-1000): ", 100, 1000));
            SimulationParameters.Add(GetInputInRange("Enter starting number of food cells (1-10): ", 1, 10));
            SimulationParameters.Add(GetInputInRange("Enter starting ants in each nest (5-20): ", 5, 20));
            SimulationParameters.Add(GetInputInRange("Enter new pheromone strength (500-2000): ", 500, 2000));
            SimulationParameters.Add(GetInputInRange("Enter pheromone decay per stage (10-200): ", 10, 200));
            return SimulationParameters;
        }
        static int GetInputInRange(string Prompt, int Min, int Max)
        {
            int Input;
            do
            {
