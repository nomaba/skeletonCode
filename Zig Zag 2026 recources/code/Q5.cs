...
namespace AntSimCS          //Q5
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            {
                case "1":
                    SimulationParameters = new List<int> { 1, 5, 5, 500, 1, 5, 1000, 50 };
                    break;
                case "2":
            ...
            do
            {
                ...
                {
                    Console.WriteLine($"The simulation has ended because {ThisSimulation.GetEndReason()}");
                    break;
                }
                //END CHANGE
            } while (Choice != "9");
        ...
        class Simulation
        {
            ...
            public void AdvanceStage(int NumberOfStages)
            {
                for (int Count = 1; Count <= NumberOfStages; Count++)
                {
                    ...
                    if (Ants.Count == 0)
                    {
                        ...
                        EndReason = "all ants have perished.";
                        break;
                    }
                    ...
                    {
                        SimulationEnded = true;
                        EndReason = "all food has been collected.";
                        break;
                    }
                    //END CHANGE
                    foreach (Nest N in Nests)
            ...
            //CHANGE
            public bool HasSimulationEnded()
            {
