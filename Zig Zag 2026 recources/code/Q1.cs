        ...
        static void Main()
        {
            ...
            do
            {
                ...
                switch (Choice)
                {
                    ...
                    //CHANGE
                    case "9":
                        Console.WriteLine("Are you sure that you want to quit the simulation? yes / no");
            ...
            Console.WriteLine("Simulation Complete, press any key to close");
            //END CHANGE
            Console.ReadLine();
        }
