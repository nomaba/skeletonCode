...
namespace AntSimCS          //Q16
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            do
            {
                ...
                switch (Choice)
                {
                    ...
                    //CHANGE
                    case "6":
                        Console.WriteLine("Heat Map for the simulation");
                        Console.WriteLine(ThisSimulation.DisplayPheromoneHeatMap());
                        break;
                    //END CHANGE
        ...
        static void DisplayMenu()
        {
            ...
            //CHANGE
            Console.WriteLine("6. Display Pheromone Heat Map");
            //END CHANGE
        ...
        class Simulation
        {
            ...
            //CHANGE
            public int GetTotalPheromoneStrengthInCell(Cell C)
            {
                int TotalStrength = 0;
                foreach (Pheromone P in Pheromones)
                {
            ...
            //CHANGE
            public string DisplayPheromoneHeatMap()
            {
                int CellWidth = 10;
                string Details = "";
                string RowSeparator = "";
                ...
                for (int Column = 1; Column <= NumberOfColumns; Column++)
                {
                    HeaderRow += $"|     {Column}   ".PadRight(CellWidth - 2) + " ";
                }
                HeaderRow += "|\n";
                ...
                for (int Row = 1; Row <= NumberOfRows; Row++)
                {
                    Details += "   " + RowSeparator;
                    string RowLine = "";
                    for (int Column = 1; Column <= NumberOfColumns; Column++)
                    {
                        Cell Cell = Grid[GetIndex(Row, Column)];
                        if (Column == 1)
                        {
                            RowLine += $"{Row}".PadRight(3) +"|"+ GetTotalPheromoneStrengthInCell(Cell).ToString().PadRight(CellWidth);
                        }
                        else
                        {
                            RowLine += $"|" + GetTotalPheromoneStrengthInCell(Cell).ToString().PadRight(CellWidth);
                        }
