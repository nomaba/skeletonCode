    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            do
            {
                ...
                {
                    DisplayMenu();
                    List<int> ValidMenuOptions = new List<int> { 1, 2, 3, 4, 5, 9 };
                    Choice = GetChoice(ValidMenuOptions);
                }
                //END CHANGE
                switch (Choice)
                {
        ...
        //CHANGE
        static string GetChoice(List<int>ValidMenuOptions)
        {            
            ...
            while (!ValidChoice)
            {
                ...
                try
                {
                    ...
                    if (ValidMenuOptions.Contains(ChoiceAsInt))
                    {
                        ValidChoice = true;
                        return Choice;
                    }
