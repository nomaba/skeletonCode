...
namespace AntSimCS
{
    class Program
    {
        ...
        static string GetChoice()
        {
            ...
            bool MenuAlreadyDisplayed = false;
            while (validUserInput == false)
            {
                if (MenuAlreadyDisplayed == false)
                {
                    MenuAlreadyDisplayed = true;
                }
                else
                {
                    DisplayMenu();
                ...
                try
                {
                    ...
                    {
                        Console.WriteLine("Your input is out of range, input it again");
                    }
                }
                catch
                {
                    Console.WriteLine("Your input is not in the correct format, input it again");
                }
            }
            return Choice;
        }
